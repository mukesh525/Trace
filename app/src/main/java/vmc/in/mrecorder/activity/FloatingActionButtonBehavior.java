...
public class FloatingActionButtonBehavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionsMenu> {
...
//        }
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, FloatingActionsMenu child, View dependency) {
        final boolean b = dependency instanceof Snackbar.SnackbarLayout;
...
// Only one fab.
    ...
    public void onDependentViewRemoved(CoordinatorLayout parent, FloatingActionsMenu child, View dependency) {
        ...
        }if (dependency instanceof RecyclerView && ViewCompat.getTranslationY(child) != 0.0F) {
            ViewCompat.animate(child).translationY(0.0F).scaleX(1.0F).scaleY(1.0F).alpha(1.0F).setInterpolator(FAST_OUT_SLOW_IN_INTERPOLATOR).setListener((ViewPropertyAnimatorListener) null);
        }
    }
}