...
public class SpeedDialAdapter extends RecyclerView.Adapter<SpeedDialAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(SpeedDialAdapter.ViewHolder holder,final int position) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.one://play
                                try{
                                    Log.e("calling"+ c.getString(3), "play"+position);
                            ...
                            case R.id.three://share
                                ...
                                break;
                            case R.id.four://add to contacts
        ...
        String scalltype=c.getString(calltypeindex);c.getColumnIndex("CallType");
